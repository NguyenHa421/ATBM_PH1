...
begin
    ...
    if userExist > 0 then
        execute immediate 'DROP USER ' ||usrName;
    end if;
    close usr;
end;
/
...
----------------------------------------------------------
-- NHAP DU LIEU
INSERT INTO ADMIN.TB_DONVI (MADV, TENDV) VALUES
...
-- DATA ENTRY
INSERT INTO ADMIN.TB_NHANSU (MANV, HOTEN, PHAI, NGSINH, PHUCAP, DT, VAITRO, MADV) VALUES 
...
UPDATE ADMIN.TB_DONVI SET TRGDV = 'NS41' WHERE MADV = 'DV01';
UPDATE ADMIN.TB_DONVI SET TRGDV = 'NS43' WHERE MADV = 'DV03';
UPDATE ADMIN.TB_DONVI SET TRGDV = 'NS44' WHERE MADV = 'DV04';
UPDATE ADMIN.TB_DONVI SET TRGDV = 'NS45' WHERE MADV = 'DV05';
UPDATE ADMIN.TB_DONVI SET TRGDV = 'NS46' WHERE MADV = 'DV06';
UPDATE ADMIN.TB_DONVI SET TRGDV = 'NS51' WHERE MADV = 'DV02';

-- ADMIN.TB_NGANH
INSERT INTO ADMIN.TB_NGANH (MANGANH, TENNGANH) VALUES
...
-- Sinh vien-- Students
INSERT INTO ADMIN.TB_SINHVIEN (MASV, HOTEN, PHAI, NGSINH, DCHI, DT, MACT, MANGANH, SOTCTL, DTBTL) VALUES
...
--Hoc phan
INSERT INTO ADMIN.TB_HOCPHAN (MAHP, TENHP, SOTC, STLT, STTH, SOSVTD, MADV) VALUES
...
-- ADMIN.TB_KHMO 
INSERT INTO ADMIN.TB_KHMO (MAHP, HK, NAM, MACT) VALUES
('HP01', 1, 2023, 'CT01');
INSERT INTO ADMIN.TB_KHMO (MAHP, HK, NAM, MACT) VALUES
('HP02', 1, 2023, 'CT02');
INSERT INTO ADMIN.TB_KHMO (MAHP, HK, NAM, MACT) VALUES
...
-- Phan cong 
INSERT INTO ADMIN.TB_PHANCONG (MAGV, MAHP, HK, NAM, MACT) VALUES
...
-- Dang ky
INSERT INTO ADMIN.TB_DANGKY (MASV, MAGV, MAHP, HK, NAM, MACT, DIEMTH, DIEMQT, DIEMCK, DIEMTK) VALUES
