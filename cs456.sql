...
GRANT SELECT, INSERT, DELETE, UPDATE ON UV_TDVXEMPHANCONG TO NV101;
GRANT SELECT, INSERT, DELETE, UPDATE ON UV_TDVXEMPHANCONG TO NV102;
GRANT SELECT, INSERT, DELETE, UPDATE ON UV_TDVXEMPHANCONG TO NV103;
GRANT SELECT, INSERT, DELETE, UPDATE ON UV_TDVXEMPHANCONG TO NV104;
GRANT SELECT, INSERT, DELETE, UPDATE ON UV_TDVXEMPHANCONG TO NV105;
GRANT SELECT, INSERT, DELETE, UPDATE ON UV_TDVXEMPHANCONG TO NV106;
...
CREATE OR REPLACE VIEW UV_XEMDANGKY AS
    SELECT DK.*, NS.HOTEN AS HOTENGV, SV.HOTEN AS HOTENSV
    FROM TB_DANGKY DK, TB_NHANSU NS, TB_SINHVIEN SV
...
GRANT SELECT ON UV_XEMDANGKY TO NV101;
GRANT SELECT ON UV_XEMDANGKY TO NV102;
GRANT SELECT ON UV_XEMDANGKY TO NV103;
GRANT SELECT ON UV_XEMDANGKY TO NV104;
GRANT SELECT ON UV_XEMDANGKY TO NV105;
GRANT SELECT ON UV_XEMDANGKY TO NV106;

/
-- CS#5
--YC1
EXEC USP_GANQUYEN_NVCB('NV107');
